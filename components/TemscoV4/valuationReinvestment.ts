import { firstPassAssumptions as assumptions, forecastEndYear } from './valuationInputs'
...
// V4 source workbooks only; original spreadsheet values and cell references retained in valuation-source.json.
export const openingAssetPools = assumptions.openingAssetPools
export const growthAssetPlan = assumptions.growthAssetPlan
...
export function buildReinvestmentSchedule(options: ReinvestmentOptions = {}): ReinvestmentYear[] {
  ...
  const endYear = options.endYear ?? forecastEndYear
