...
인류의 오만함과 기술 격차를 보여주는 상징. 200년간 노력했지만 삼체의 탐사선 하나를 막지 못했다.`,
  ...
  },
  {
    ...
    description: `말일 전투와 암흑 전투에서 살아남은 함선. 이후 광속 우주선으로 개조되어 삼체와 지구의 좌표를 브로드캐스트했다. 중력호의 추격을 받으며 미스테리한 사건을 겪었다.`,
...
4. **중력호의 추격** - 미스테리한 사건 발생 (함내 괴현상)
5. **광속 추진** - 외계 기술로 광속 우주선 개조
6. **최후의 방송** - 삼체와 지구 좌표 동시 브로드캐스트

**함장 우웨이:**
장베이하이의 뜻을 이어받아 인류 종족의 씨앗을 우주에 퍼뜨리려 했다.

**중력호 추격 당시 주요 인물:**
- 데번 중령 (최후전쟁 생존자) - 박의군 소령(북한군)과 협력
- 아이크 중위 - 베라 중위(러시아군 미녀)와 함께 조사
- 정신과 의사 웨스트 - 승무원들의 심리 상태 관리
- 류샤오밍 중사 - 실종 사건 조사
- 관이판 (선미의 은둔자) - 관측 스테이션에서 폐소공포증과 싸움

**결정적 행동:**
블루스페이스호가 좌표를 브로드캐스트한 것이 삼체 멸망과 태양계 이차원화의 직접적 원인이 되었다. 이것은 암흑의 숲 법칙의 실제 증명이었다.`,
    relatedCharacters: ['우웨이', '장베이하이', '관이판', '정신과 의사 웨스트', '데번 중령', '박의군 소령', '아이크 중위', '베라 중위', '류샤오밍'],
    relatedEvents: ['말일 전투', '암흑 전투', '삼체 멸망', '암흑의 숲 타격', '중력호 추격전'],
  ...
  },
  {
    ...
    description: `정청신과 관이판이 개발한 인류 최초의 광속 우주선. 곡률 추진 엔진을 탑재하여 빛의 속도로 이동 가능. 블루스페이스호를 추격하며 함내에서 미스테리한 사건을 겪었다.`,
...
**블루스페이스호 추격 사건:**
중력호가 블루스페이스호를 추격하는 동안, 함내에서 설명할 수 없는 미스테리한 사건들이 발생했다. 이 시기의 주요 인물들:

- **정신과 의사 웨스트** - 승무원들의 심리 상태를 진단하고 관리
- **데번 중령** (최후전쟁 생존자) - 박의군 소령(북한군)과 협력하여 사건 조사
- **아이크 중위** - 베라 중위(러시아군 미녀)와 함께 미스테리 해결에 나섰다
- **류샤오밍 중사** - 실종 및 괴현상 조사
- **관이판** (선미의 은둔자) - 관측 스테이션에서 고립된 채 폐소공포증과 싸우며 진실을 추적

이 추격전 동안 함내에서는 환각, 실종, 공간 왜곡 등 설명할 수 없는 현상들이 발생했다. 승무원들 간의 심리적 긴장과 극한 상황에서의 인간성 시험이 이루어졌다.
...
정청신이 더 일찍 개발을 허용했다면 수백만 명이 탈출할 수 있었다. 하지만 그녀의 결정으로 인류는 멸망했고, 중력호만이 태양계를 탈출했다.`,
    relatedCharacters: ['정청신', '관이판', '토마스 웨이드', '정신과 의사 웨스트', '데번 중령', '박의군 소령', '아이크 중위', '베라 중위', '류샤오밍'],
    relatedEvents: ['광속 우주선 개발', '태양계 이차원화', '우주 재시작', '중력호 추격전'],
