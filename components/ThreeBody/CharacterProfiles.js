...
const characters = [
  ...
  },
  {
    ...
    fate: '말일 전투에서 전사',
    background: '뛰어난 전술 능력과 리더십으로 존경받는 여성 함대 사령관. 장베이하이에게 선물을 전하며 선배로 존경했다. 이름은 "동방의 연속"을 의미하며, 인류 문명의 계승을 상징한다.'
  },
  {
    initial: '켄',
    name: '켄 박사',
    ...
    actions: [
      '린저-피츠로이 관측소 운영',
      '우주학 연구 수행',
      '관측소 빠른 자전 주장 (지구 중력 수준)',
      '로빈슨 장군과 대립'
    ],
    fate: '생존',
    background: '자신의 우주학 연구를 위해 망원경을 사용하려 함. 관측소를 빠르게 자전시켜 지구만큼의 중력을 발생시켜야 한다고 주장하며 로빈슨 장군과 대립.'
  },
  {
    initial: '로',
    name: '로빈슨 장군',
    chinese: 'General Robinson',
    role: '린저-피츠로이 관측소 책임자',
    actions: [
      '린저-피츠로이 관측소 운영',
      '함대 이익과 권력 수호',
      '켄 박사의 연구 목적 망원경 사용 저지',
      '관측소 느린 자전 또는 무중력 상태 주장'
    ],
    fate: '생존',
    background: '함대의 이익과 권력을 지키기 위해 켄 박사의 연구 목적 망원경 사용을 저지. 관측소를 느린 속도로 자전시켜 약한 중력만 발생시키거나, 무중력 상태를 유지하자고 주장하며 켄과 대립.'
  }
]
