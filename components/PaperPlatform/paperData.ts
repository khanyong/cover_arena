      ...
      },
      {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "## 3장. 수학적 정식화 (Mathematical Formulation)",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "## 3장. 수학적 정식화 (Mathematical Formulation)"
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              ...
              "v3": {
                "ko": "본 모델에서는 고전적 해밀턴-야코비 방정식에 추가된 위 항을 '공간 진동 퍼텐셜(Spatial Vibration Potential, $Q_s$)'이라 명명한다.",
                "en": "In this model, the additional term is designated as the 'Spatial Vibration Potential ($Q_s$).' While its mathematical form is identical to the 'Quantum Potential' derived by David Bohm [3], we redefine it not as a hidden field associated with the particle, but as the 'geometric fluctuation energy of the background space itself.'"
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              ...
              "v3": {
                "ko": "",
                "en": "### Critical Review of Preceding Theories: Mechanical Sublimation from 'Hidden Variables' to 'Geometrical Spatial Vibration'"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "본 장에서는 복소 파동 함수를 기반으로 하는 슈뢰딩거 방정식이 어떻게 물리적 실재를 기술하는 '공간 진동 방정식'으로 변환되는지, 그 도출 과정을 수학적으로 증명한다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "실수부 항을 정리하면, 고전적 해밀턴-야코비 방정식에 양자적 섭동 항이 추가된 형태가 나타난다:",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "이를 이항하여 정리하면, 우리가 정의하는 핵심 방정식이 도출된다:",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "허수부 항을 정리하면, 입자의 발견 확률 밀도 보존 법칙(Continuity Equation)이 도출된다:",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "이 식은 공간에서 진동 에너지 밀도($R^2$)가 보존됨을 의미한다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "### ~~3.3. 공간 진동 퍼텐셜 ($Q_s$)의 정의 및 물리적 해석~~",
                "en": ""
              }
            }
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "위 실수부 방정식에서 마지막 항을 **공간 진동 퍼텐셜(Spatial Vibration Potential, $Q_s$)**이라 정의한다:",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "- $Q_s$는 입자 내부에 존재하는 에너지가 아니라, 배경 공간($R$)의 곡률(Laplacian)에 의해 결정되는 기하학적 요동 에너지이다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "- 이로써, 고전 역학의 에너지 보존 방정식($E = K + V$)은 공간의 진동이 결합된 형태로 확장된다:",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "이제 입자의 운동은 외부 퍼텐셜($V$)뿐만 아니라, **공간 그 자체의 기하학적 요동($Q_s$)에 의해 결정론적으로 유도된다.** 이것이 본 연구가 제안하는 결정론적 양자 역학의 수학적 근간이다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "### 3.4. 선행 이론의 비판적 고찰: '은닉 변수'에서 '기하학적 공간 진동'으로의 역학적 승화",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "#### [실수부 (Real Part): 양자 해밀턴-야코비 방정식]"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "### ~~3.3. 공간 진동 퍼텐셜 ($Q_s$)의 정의 및 물리적 해석~~"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "Defining the Schrödinger equation:\n$$ i\\hbar \\frac{\\partial \\psi}{\\partial t} = -\\frac{\\hbar^2}{2m} \\nabla^2 \\psi + V\\psi $$\nWe decompose the wave function $\\psi(\\mathbf{r}, t)$ into a polar form using the geometrical amplitude $R(\\mathbf{r}, t)$ and phase action $S(\\mathbf{r}, t)$ [2]:\n$$ \\psi(\\mathbf{r}, t) = R(\\mathbf{r}, t) e^{iS(\\mathbf{r}, t)/\\hbar} $$"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "**[Imaginary Part: Continuity Equation]**\nRearranging the imaginary part yields a continuity equation indicating the conservation of vibration energy density ($R^2$) in space.\n$$ \\frac{\\partial R^2}{\\partial t} + \\nabla \\cdot \\left( R^2 \\frac{\\nabla S}{m} \\right) = 0 $$"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v5": {
                "ko": "",
                "en": "**[Real Part: Quantum Hamilton-Jacobi Equation]**\nRearranging the real part yields the classical Hamilton-Jacobi equation with an added quantum perturbation term.\n$$ \\frac{\\partial S}{\\partial t} + \\frac{(\\nabla S)^2}{2m} + V - \\frac{\\hbar^2}{2m} \\frac{\\nabla^2 R}{R} = 0 $$\nThis added term is defined as the **'Spatial Vibration Potential ($Q_s$)'**. Although algebraically identical to Bohm's quantum potential [3], this study completely redefines it not as a metaphysical hidden variable, but as the **'geometrical fluctuation energy of the 3D physical background space itself'**.\n$$ Q_s \\equiv -\\frac{\\hbar^2}{2m} \\frac{\\nabla^2 R}{R} \\quad \\Rightarrow \\quad \\frac{\\partial S}{\\partial t} + \\frac{(\\nabla S)^2}{2m} + V + Q_s = 0 $$"
              }
            }
          },
          {
            ...
            "versions": {
              "v5": {
                "ko": "",
                "en": "**[Imaginary Part: Continuity Equation]**\n$$ \\frac{\\partial R^2}{\\partial t} + \\nabla \\cdot \\left( R^2 \\frac{\\nabla S}{m} \\right) = 0 $$\nThis proves that spatial vibration energy density ($R^2$) is conserved, maintaining a physical flow without loss in 4D spacetime."
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v5": {
                "ko": "",
                "en": "*   **Casimir Effect:** A classical tensor compression caused by the difference in macroscopic 'vibrational radiation pressure ($p_{vib}$)' outside versus suppressed waves inside narrowly spaced metal plates.\n*   **Superconductivity:** At absolute zero, thermal perturbations cease, allowing tensor vortices to form perfect macroscopic topological locking ($\\Gamma=0$), creating a zero-resistance superfluid tensor flow.\n*   **Black Hole Information Paradox & Arrow of Time:** Information (tensor phase) is tightly twisted into the black hole and preserved, later released via geometrical elastic restoration during Hawking radiation. The irreversible accumulation of 'Topological Scars' dictates the unidirectional flow of time."
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "As an object scales up to the macroscopic level:\n$$ \\lim_{m \\to \\infty} \\mathbf{F}_{space} = 0 $$\nThe spatial fluctuation is not destroyed; rather, the overwhelming **'classical inertia'** of macroscopic objects mechanically ignores and pierces through the local spatial vibrations. Therefore, the trajectory equation naturally converges to Newton's second law of motion ($m \\frac{d\\mathbf{v}}{dt} = -\\nabla V$)."
              }
            }
          },
          {
    ...
    "abstract": {
      "versions": {
        ...
        "v7": {
          ...
          "en": "To address the cosmological challenges associated with anomalous galactic rotation curves and the accelerating expansion of the universe, this study explores a geomechanical alternative to standard dark matter and dark energy paradigms. Building upon the 'Geometrical Fluctuation of Space' hypothesis introduced in Part I, this paper proposes an effective unified model by incorporating a phenomenological 'Spatial Vibration Tensor' ($\\\\tilde{V}_{\\\\mu\\\\nu}$) into the Einstein Field Equations.\nTo preserve the equivalence principle and local energy-momentum conservation, spatial vibration is modeled as high-frequency perturbations to the background metric, rigorously averaged via the Isaacson limit ($\\\\tilde{V}_{\\\\mu\\\\nu} \\\\propto \\\\langle \\\\nabla_\\\\mu h_{\\\\alpha\\\\beta}^{vib} \\\\nabla_\\\\nu h^{\\\\alpha\\\\beta}_{vib} \\\\rangle$). We propose a 'Unified Dark Fluid' behavior employing a heuristic chameleon-like transition function: in dense galactic halos, fierce vibrational waves form highly coherent standing waves. In this phase-locked state, kinematic pressure time-averages to zero ($w \\\\approx 0$), emerging as an effective mass that generates surplus gravity (phenomenological Dark Matter). Conversely, in vast cosmic voids, the unsuppressed potential tension of the vacuum acts as a repulsive vibrational radiation pressure ($w \\\\to -1$), driving accelerated expansion (Dark Energy). Furthermore, micro-perturbations in gravitational lensing are rigorously modeled as stochastic geodesic deviations, predicting 'Achromatic Optical Blurring'. Optical illusions induced by spatial junctions are proposed as 'Geometrical Path-Shortening' to address chronological discrepancies in early galaxy observations."
        },
        "v8": {
          "ko": "은하 회전 곡선 이상과 우주의 가속 팽창 문제를 해결하기 위해, 본 연구는 아인슈타인 장 방정식에 현상론적인 **'공간 진동 텐서($\\\\tilde{V}_{\\\\mu\\\\nu}$)'**를 도입하여 통합적인 기하역학 모델을 제안한다.\n본 모델은 등가원리와 에너지-운동량 보존을 준수하기 위해 공간 진동을 계량 텐서의 고주파 섭동으로 모델링하고 아이작슨 한계($\\\\tilde{V}_{\\\\mu\\\\nu} \\\\propto \\\\langle \\\\nabla_\\\\mu h_{\\\\alpha\\\\beta}^{vib} \\\\nabla_\\\\nu h^{\\\\alpha\\\\beta}_{vib} \\\\rangle$)를 통해 거시적으로 평균화한다. 주변 물질 밀도($\\\\rho_m$)에 동역학적으로 결합하는 카멜레온 장 메커니즘을 도입하여, 은하 헤일로에서는 운동 에너지 모드가 갇혀 **'텐서 응축'**($w \\\\approx 0$)을 일으키고 잉여 중력(암흑 물질)을 창발한다. 거대 공동에서는 퍼텐셜 모드가 지배적($w \\\\to -1$)이 되어 방출되는 진동 복사압($p_{vib} < 0$)이 가속 팽창(암흑 에너지)을 주도한다.\n나아가 고주파 섭동에 의한 **'확률론적 측지선 편차'** 방정식을 유도하여 반증 가능한 **'파장 무관(Achromatic) 광학적 번짐'**을 예측하며, 음압으로 지탱되는 공간 접합부를 통한 **'기하학적 경로 단축'**이 연대기적 착시를 일으키는 기제로 제안된다.",
          "en": "To address anomalous galactic rotation curves and the accelerating expansion of the universe, this study explores a geomechanical alternative to standard dark matter and dark energy paradigms. We propose a unified model incorporating a phenomenological 'Spatial Vibration Tensor' ($\\\\tilde{V}_{\\\\mu\\\\nu}$) into the Einstein Field Equations.\nTo preserve local energy-momentum conservation, spatial vibration is rigorously averaged via the Isaacson limit ($\\\\tilde{V}_{\\\\mu\\\\nu} \\\\propto \\\\langle \\\\nabla_\\\\mu h_{\\\\alpha\\\\beta}^{vib} \\\\nabla_\\\\nu h^{\\\\alpha\\\\beta}_{vib} \\\\rangle$). We propose a 'Unified Dark Fluid' employing a chameleon-like transition function: in dense halos, constructive interference traps kinetic modes ($w \\\\approx 0$), generating surplus gravity (Dark Matter). In vast cosmic voids, the unsuppressed potential tension acts as a repulsive vibrational radiation pressure ($w \\\\to -1$), driving accelerated expansion (Dark Energy). Micro-perturbations in lensing are modeled as stochastic geodesic deviations, predicting 'Achromatic Optical Blurring' and optical time-leaps sustained by negative pressure."
        },
        "v9": {
    ...
    "chapters": [
      {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "이 초거시적 관점에서 본 논문은 일반상대성이론이 기술하는 거시적 시공간 곡률과 본 연구가 제안하는 미시적 기하학적 공간 요동 사이의 역학적 상호작용을 탐구한다. 시공간 곡률이 공간 진동을 왜곡하고, 이것이 다시 유효 에너지-운동량 텐서에 동역학적으로 기여하는 피드백 루프를 공식화함으로써, 본 연구는 암흑 물질과 암흑 에너지 현상을 텅 빈 공간 자체의 역학적 상전이 현상으로 재해석하고자 시도한다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "",
                "en": "The standard Einstein Field Equations typically assume the vacuum state to be a smooth continuum. To describe the kinetic energy and geometrical repulsive radiation pressure inherently emitted by the vibrating empty space, a phenomenological **'Spatial Vibration Tensor' ($\\tilde{V}_{\\mu\\nu}$)** is introduced:\n$$G_{\\mu\\nu} = \\frac{8\\pi G}{c^4} \\left( T_{\\mu\\nu} + \\tilde{V}_{\\mu\\nu} \\right)$$\nSpatial vibration is treated as high-frequency metric perturbations ($g_{\\mu\\nu} = \\bar{g}_{\\mu\\nu} + h_{\\mu\\nu}^{vib}$). The effective spatial vibration tensor $\\tilde{V}_{\\mu\\nu}$ is mathematically constructed analogously to the Isaacson high-frequency limit, ensuring strict covariance."
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "### 2.1. Spatial Vibration Tensor and Isaacson Averaging"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "Spatial vibration is treated as high-frequency metric perturbations ($g_{\\mu\\nu} = \\bar{g}_{\\mu\\nu} + h_{\\mu\\nu}^{vib}$). Since the linear spatial average of a pure wave is exactly zero ($\\langle h_{\\mu\\nu}^{vib} \\rangle = 0$), the effective spatial vibration tensor $\\tilde{V}_{\\mu\\nu}$ is mathematically constructed analogously to the Isaacson high-frequency limit [2]. It is derived from the macroscopic spatial averaging of the quadratic derivative terms of the metric perturbations, ensuring strict covariance:\n$$ \\tilde{V}_{\\mu\\nu} \\propto \\frac{c^4}{G} \\langle \\nabla_\\mu h_{\\alpha\\beta}^{vib} \\nabla_\\nu h^{\\alpha\\beta}_{vib} \\rangle $$"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "",
                "en": "Because the background metric contains high-frequency spatial vibrations, the Christoffel symbols undergo stochastic fluctuations. While the macroscopically averaged $\\tilde{V}_{\\mu\\nu}$ generates spacetime curvature, the microscopic perturbations $h_{\\mu\\nu}^{vib}$ themselves act as the source of stochastic scattering. Light perfectly follows the null geodesic of this perturbed metric, resulting in a **'Stochastic Geodesic Deviation'**:\n$$\\frac{d^2 x^\\mu}{d\\lambda^2} + \\left( \\bar{\\Gamma}^\\mu_{\\rho\\sigma} + \\delta \\Gamma^\\mu_{\\rho\\sigma}(h^{vib}) \\right) \\frac{dx^\\rho}{d\\lambda} \\frac{dx^\\sigma}{d\\lambda} = 0$$\nWe predict a strictly **'Achromatic Blurring'**—an identical blurring width across all frequency bands, serving as a definitive falsification standard against plasma scattering.\nIf starlight penetrates a macroscopic **'Spatial Junction'**, light bypasses physical distances in effectively zero time ($t \\approx 0$). To avoid violating causality, we propose that this junction is dynamically sustained by the extreme **Negative Pressure ($p_{vib} < 0$)**. Consequently, the mature early galaxies discovered by JWST are a profound **Chronological Illusion**."
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "The modified geodesic equation in a fluctuating space is:\n$$ \\frac{d^2 x^\\mu}{d\\lambda^2} + \\left( \\Gamma^\\mu_{\\rho\\sigma} + \\delta \\Gamma^\\mu_{\\rho\\sigma}(\\tilde{V}) \\right) \\frac{dx^\\rho}{d\\lambda} \\frac{dx^\\sigma}{d\\lambda} = \\mathbf{f}_{jitter} $$\nHere, $\\mathbf{f}_{jitter}$ denotes the microscopic vibrational jittering friction error."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "First, high-resolution observations of gravitational lenses (Einstein Rings) should inevitably reveal sub-pixel scattered **'Optical Blurring (Micro-Scattering)'** at the edges, caused by photons colliding with rough vibrational terrain.\nSecond, because light must detour along undulating vibrational valleys, a **'Surplus Phase Delay ($\\Delta t_{vibration}$)'** proportional to the path integral of the spatial vibration tensor must be observed, supplementary to the classical Shapiro time delay [2].\n$$ \\Delta t_{total} = \\Delta t_{classical} + \\int \\tilde{V}_{\\mu\\nu} dl $$"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "A phenomenologically modified geodesic equation is proposed:\n$$ \\frac{d^2 x^\\mu}{d\\lambda^2} + \\left( \\Gamma^\\mu_{\\rho\\sigma} + \\delta \\Gamma^\\mu_{\\rho\\sigma}(\\tilde{V}) \\right) \\frac{dx^\\rho}{d\\lambda} \\frac{dx^\\sigma}{d\\lambda} = \\mathbf{f}_{\\mathrm{jitter}} $$\nHere, $\\mathbf{f}_{\\mathrm{jitter}}$ denotes an effective microscopic vibrational scattering term."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "제1논문에서 규명한 '거리 0의 공간 접합($\\Omega$형 위상 튜브)' 현상이 거시 텐서 응축 지대에서 발현될 경우, 심우주의 별빛이 기하학적으로 극단적으로 꼬여 맞닿은 거시적 **'공간 접합부(Spatial Junction)'**를 관통하게 된다. 이때 빛은 물리적인 수백만 광년 거리를 시간 지연 없이($t \\approx 0$) 순식간에 건너뛰는 **'기하학적 경로 단축(Geometrical Path-Shortening)'**을 겪게 된다.",
                "en": ""
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "통과 가능한 웜홀이 야기하는 인과율 위배와 음의 에너지 역설을 피하기 위해, 본 모델은 이 접합부 내부가 (4.1절의 카멜레온 메커니즘에 따라) 강력한 **음압($p_{vib} < 0$)**에 의해 역학적으로 지탱된다고 제안한다. 빛은 국소적 광속($c$)을 철저히 보존하지만, 텐서 응결이 시공간을 극도로 압축하는 기하학적 렌즈 역할을 하여 JWST의 조숙 은하들과 같은 심각한 **'연대기적 착시(Chronological Illusion)'**를 일으킬 뿐이다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "To preserve the Einstein Equivalence Principle, we do not introduce arbitrary forces into the right-hand side. Instead, because the background metric itself contains high-frequency spatial vibrations ($h_{\\mu\\nu}^{vib}$), the Christoffel symbols undergo stochastic fluctuations ($\\Gamma^\\mu_{\\rho\\sigma} = \\bar{\\Gamma}^\\mu_{\\rho\\sigma} + \\delta \\Gamma^\\mu_{\\rho\\sigma}(\\tilde{V})$). Light perfectly follows the null geodesic of this perturbed metric, resulting in a **'Stochastic Geodesic Deviation'**:\n$$ \\frac{d^2 x^\\mu}{d\\lambda^2} + \\left( \\bar{\\Gamma}^\\mu_{\\rho\\sigma} + \\delta \\Gamma^\\mu_{\\rho\\sigma}(\\tilde{V}) \\right) \\frac{dx^\\rho}{d\\lambda} \\frac{dx^\\sigma}{d\\lambda} = 0 $$"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "### 3.3. Geometrical Path-Shortening and Chronological Illusions"
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "The 'zero-distance spatial junction' ($\\Omega$-shaped phase tube) phenomenon established in Part I can manifest macroscopically in extreme tensor condensation zones. If starlight from deep space penetrates a macroscopic **'Spatial Junction'**—where severely twisted space folds onto itself, short-circuiting the internal geometrical distance—light bypasses immense physical distances."
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "To avoid violating causality via traversable wormholes (which require unphysical negative energy), we propose that this junction is dynamically sustained by the extreme **Negative Pressure ($p_{vib} < 0$)** generated via the chameleon mechanism (Section 4.1). Furthermore, this **'Geometrical Path-Shortening'** does not violate the local speed of light $c$. The tensor condensation acts as an extreme 'Geometric Magnifier'. Consequently, the 'impossibly mature early galaxies' recently discovered by JWST are a profound **Chronological Illusion** caused by light traveling through these geometrically shortened paths, arriving earlier than expected while strictly preserving relativistic causality."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "",
                "en": "We adopt a dynamic analogous to Chameleon Cosmology. The equation of state parameter $w$ dynamically couples to the ambient baryonic matter density ($\\rho_m$):\n$$w(\\rho_m) \\approx -1 + \\frac{1}{1 + e^{-(\\rho_m - \\rho_{crit})/\\sigma}}$$\nIn galactic halos, kinetic modes are trapped, and rapid oscillations time-average the effective kinematic pressure to zero ($\\langle p_{vib} \\rangle \\approx 0$). This **'Tensor Condensation'** assumes an 'Effective Mass':\n$$M_{eff}(r) = M_{visible}(r) + \\frac{4\\pi}{c^2} \\int_{0}^{r} \\langle \\tilde{V}_{00} \\rangle \\sqrt{g_{rr}} \\, r'^2 dr'$$\nIn vast Cosmic Voids ($\\rho_m \\ll \\rho_{crit}$), the chameleon coupling shifts to $w \\to -1$. The intrinsic geometrical vibration fiercely radiates a repulsive pressure. Substituting this into the Friedmann acceleration equation yields:\n$$\\frac{\\ddot{a}}{a} = -\\frac{4\\pi G}{3} \\left( \\rho_m + \\rho_{vib} + \\frac{3p_{vib}}{c^2} \\right)$$\nWhere $p_{vib} \\approx -\\rho_{vib} c^2$, the dark fluid term becomes $(\\rho_{vib} - 3\\rho_{vib}) = -2\\rho_{vib}$. This negative effective gravitational mass overwhelmingly drives a deterministic positive feedback loop of accelerated expansion ($\\ddot{a}>0$)."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v9": {
                "ko": "",
                "en": "We adopt a dynamic analogous to Chameleon Cosmology. The equation of state parameter $w$ dynamically couples to the ambient baryonic matter density ($\\rho_m$):\n$$w(\\rho_m) \\approx -1 + \\frac{1}{1 + e^{-(\\rho_m - \\rho_{crit})/\\sigma}}$$\nIn galactic halos, kinetic modes are trapped, and rapid oscillations time-average the effective kinematic pressure to zero ($\\langle p_{vib} \\rangle \\approx 0$). This **'Tensor Condensation'** assumes an 'Effective Mass':\n$$M_{eff}(r) = M_{visible}(r) + \\frac{4\\pi}{c^2} \\int_{0}^{r} \\langle \\tilde{V}_{00} \\rangle \\sqrt{g_{rr}} \\, r'^2 dr'$$\nIn vast Cosmic Voids ($\\rho_m \\ll \\rho_{crit}$), the chameleon coupling shifts to $w \\to -1$. The intrinsic geometrical vibration fiercely radiates a repulsive pressure: $p_{vib} \\approx -\\rho_{vib} c^2$.\n$$ \\frac{\\ddot{a}}{a} = -\\frac{4\\pi G}{3} \\left( \\rho_m + \\rho_{vib} + \\frac{3p_{vib}}{c^2} \\right) $$\nWhere $p_{vib} \\approx -\\rho_{vib} c^2$, the dark fluid term becomes $(\\rho_{vib} - 3\\rho_{vib}) = -2\\rho_{vib}$. This negative effective active gravitational mass cancels the negative sign of the equation, overwhelmingly driving a deterministic positive feedback loop of accelerated expansion ($\\ddot{a}>0$)."
              }
            }
          }
        ]
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "By Einstein's mass-energy equivalence ($E=mc^2$), this extremely condensed geometrical tensor energy assumes an 'Effective Mass' and creates surplus gravity [4].\n$$ M_{eff}(r) = M_{visible}(r) + \\frac{1}{c^2} \\int_{0}^{r} \\tilde{V}_{00}(r') \\, 4\\pi r'^2 dr' $$\nTherefore, Dark Matter is not an unknown alien particle; it is the **geometrical surplus gravity created by the massive spatial vibration energy of empty space itself, extremely condensed and boiling within the galactic gravity well.**"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v5": {
                "ko": "",
                "en": "In vast Cosmic Voids devoid of matter ($\\rho_m \\to 0$), the chameleon coupling releases the tensor tension. The potential energy mode dominates, shifting the equation of state to $w \\approx -1$. The intrinsic geometrical vibration of space fiercely radiates a powerful repulsive pressure outward:\n$$ p_{vib} \\approx -\\rho_{vib} c^2 $$\nSubstituting this vibrational radiation pressure into the Friedmann acceleration equation yields:\n$$ \\frac{\\ddot{a}}{a} = -\\frac{4\\pi G}{3} \\left( \\rho_m + \\frac{3p_{vib}}{c^2} \\right) $$\nAs the universe expands and matter density ($\\rho_m$) dilutes, the total **'Vibrational Radiation Pressure ($p_{vib}$)'** emitted by the exponentially growing vacuum volume increases. Overcoming the attractive force of matter, it drives a deterministic positive feedback loop of accelerated expansion ($\\ddot{a}>0$)."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v6": {
                "ko": "",
                "en": "In vast Cosmic Voids ($\\rho_m \\ll \\rho_{crit}$), the chameleon coupling shifts to $w \\to -1$. The intrinsic geometrical vibration of space fiercely radiates a powerful repulsive pressure outward:\n$$ p_{vib} \\approx -\\rho_{vib} c^2 $$\nSubstituting this into the Friedmann acceleration equation yields:\n$$ \\frac{\\ddot{a}}{a} = -\\frac{4\\pi G}{3} \\left( \\rho_m + \\frac{3p_{vib}}{c^2} \\right) $$\nAs the universe expands and matter dilutes, the repulsive pressure emitted by the growing vacuum volume increases exponentially, driving a deterministic positive feedback loop of accelerated expansion ($\\ddot{a}>0$)."
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "이 장은 $\\Lambda$CDM 우주론 [4]을 대체하여 암흑 물질과 암흑 에너지를 단일 공간 진동 텐서의 밀도 종속적 상전이로 해석한다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "가시적 질량 밀도가 희박한 은하 헤일로 영역에서는 '스케일 역전'에 의해 진동파들이 극한의 보강 간섭을 일으킨다. 은하 중력 우물에 갇힌 맹렬한 진동 파동들은 거시적인 보스-아인슈타인 응축과 유사하게 매우 응집력 있고 빠르게 진동하는 '정재파(Standing waves)'를 형성한다. 이 위상 고정(Phase-locked) 상태에서 빠른 진동은 유효 운동학적 압력을 시간 평균하여 0으로 소거($\\langle p_{vib} \\rangle \\approx 0$)시키며, 압력 없는 차가운 암흑 물질($w \\approx 0$)의 상태 방정식을 완벽히 모사하는 **'텐서 응축'**이 발생한다.",
                "en": ""
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "질량-에너지 등가원리에 의해 이는 잉여 중력으로 창발한다 [6]. 일반상대론적 정합성을 위해 구대칭 방사상 고유 부피 요소 $\\sqrt{g_{rr}}$를 반영하여 정확한 유효 질량 공식을 구성한다:\n$$ M_{\\mathrm{eff}}(r) = M_{\\mathrm{visible}}(r) + \\frac{4\\pi}{c^2} \\int_{0}^{r} \\langle \\tilde{V}_{00} \\rangle \\sqrt{g_{rr}} \\, r'^2 dr' $$\n따라서 암흑 물질은 미지의 입자가 아니라 은하 중력 우물 내에서 끓어오르는 극도로 응축된 공간 진동 에너지가 창출한 기하학적 잉여 중력이다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "In galactic halos ($\\rho_m > \\rho_{crit}$), 'Scale Inversion' allows spatial vibration energy to regain dynamic relevance. When fierce vibrational waves are trapped within the galactic well, they form highly coherent, rapidly oscillating 'standing waves' (analogous to a macroscopic Bose-Einstein Condensate). In this phase-locked state, the rapid oscillations time-average the effective kinematic pressure to zero ($\\langle p_{vib} \\rangle \\approx 0$), perfectly mimicking the equation of state of cold dark matter ($w \\approx 0$)."
              }
            }
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "This surge in energy density is defined as **'Tensor Condensation'**. By mass-energy equivalence, this assumes an 'Effective Mass' [6]. To rigorously account for the curvature of spacetime assuming spherical symmetry, the effective surplus mass is calculated using the proper radial metric element ($\\sqrt{g_{rr}}$):\n$$ M_{eff}(r) = M_{visible}(r) + \\frac{4\\pi}{c^2} \\int_{0}^{r} \\langle \\tilde{V}_{00} \\rangle \\sqrt{g_{rr}} \\, r'^2 dr' $$\nDark matter is thus phenomenologically reinterpreted as the geometrical surplus gravity generated by condensed spatial vibration energy boiling within the galactic gravity well."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "In vast Cosmic Voids ($\\rho_m \\ll \\rho_{crit}$), the chameleon coupling shifts to $w \\to -1$. The intrinsic geometrical vibration of space fiercely radiates a powerful repulsive pressure outward:\n$$ p_{vib} \\approx -\\rho_{vib} c^2 $$\nSubstituting this into the Friedmann acceleration equation yields:\n$$ \\frac{\\ddot{a}}{a} = -\\frac{4\\pi G}{3} \\left( \\rho_m + \\frac{3p_{vib}}{c^2} \\right) $$\nAs the universe expands and matter dilutes, the repulsive pressure emitted by the growing vacuum volume increases exponentially, driving a deterministic positive feedback loop of accelerated expansion ($\\ddot{a}>0$) [7]."
              }
            }
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "아인슈타인 장 방정식에 아이작슨 평균화된 공간 진동 텐서를 결합하고 상태 방정식 상전이를 도입함으로써, 본 논문은 암흑 물질과 암흑 에너지를 단일 암흑 유체의 동역학적 현상으로 대통합하는 재해석을 제공하였다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "",
                "en": "By coupling the Spatial Vibration Tensor with the Einstein field equations via Isaacson averaging and introducing a chameleon-like equation of state, this paper provides a unified phenomenological reinterpretation of Dark Matter and Dark Energy without violating the equivalence principle."
              }
            }
          },
          {
            ...
            "versions": {
              "v8": {
                "ko": "",
                "en": "---\n**Note on Authorship:** This work was authored by Kwang Yong Yoo. The author acknowledges the use of AI-assisted tools (Gemini) for language refinement and simulation development support. This study is an independent research work conducted under the author's sole academic responsibility."
              }
            }
          },
          {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v5": {
                "ko": "",
                "en": "**[Future Outlook: Cosmological Spatial Plate Tectonics]**\nAssuming the expanding universe cannot maintain perfect global phase coherence, it must have inevitably fragmented into numerous giant **'Topological Domains'** possessing distinct intrinsic vibrational phases. \nThe final sequel, **[Mechanics of Spatial Vibration III]**, will trace the wave friction at the macroscopic boundaries (Fault Lines) where these disconnected spatial domains collide. We will investigate their role in energy redistribution (forming the cosmic web) and trigger phenomena such as Fast Radio Bursts (FRBs) via gravitational-electromagnetic resonance."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "아인슈타인 장 방정식에 아이작슨 평균화된 공간 진동 텐서를 결합하고 밀도에 종속되는 카멜레온 형태의 상전이를 도입함으로써, 본 논문은 에너지 보존과 등가원리를 완벽히 준수하면서 암흑 물질과 암흑 에너지를 단일 암흑 유체의 동역학적 현상으로 대통합하는 재해석을 제공하였다. 파장 무관 광학적 번짐과 기하학적 경로 단축에 의한 연대기적 착시의 예측은 본 모델을 사변적 가설에서 반증 가능한 우주론으로 격상시킨다.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v7": {
                "ko": "",
                "en": "**[Future Outlook: Cosmological Spatial Plate Tectonics]**\nAssuming the expanding universe cannot maintain perfect global phase coherence, it must have inevitably fragmented into giant **'Topological Domains'** possessing distinct intrinsic vibrational phases. The final sequel, **[Mechanics of Spatial Vibration III]**, will trace the wave friction at the macroscopic boundaries (Fault Lines) of these domains. To address the Domain Wall Problem, we will discuss the early dilution of these topological defects during inflation, and investigate how their ruptures trigger Fast Radio Bursts (FRBs) via gravitational-electromagnetic resonance."
              }
            }
          }
        ]
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "**[Future Outlook: Fragmentation of Topological Domains and Cosmic Spatial Plate Tectonics]**\nIt violates causality to assume that the entire 13.8-billion-light-year universe, undergoing superluminal inflation, maintains a single perfect vibrational phase coherence. The violently expanding cosmic space must have inevitably fragmented into numerous giant **'Topological Domains'** possessing distinct intrinsic vibrational phases. \nThe final sequel, **[Mechanics of Spatial Vibration III: Cosmological Spatial Plate Tectonics]**, will trace the wave friction at the macroscopic boundaries (Fault Lines) where these massive disconnected spatial domains collide and expand against each other. This will carve out the mechanical origins of the cosmic web and declare an observational paradigm (POINTING Protocol) predicting 'Cosmic Quakes' (FRBs) erupting from tensor stress at these fault lines."
              }
            }
          }
        ]
  ...
  "spatial-vibration-3": {
    ...
    "chapters": [
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "Previous papers in this series modeled quantum and macroscopic dark phenomena through the 'geometrical fluctuation of space'. However, applying this model to the entire expanding universe confronts a fundamental phase-synchronization challenge."
              }
            }
          },
          {
      ...
      },
      {
        ...
        "title": {
          "ko": "2. 우주 공간 판구조론",
          "en": "II. Cosmological Spatial Plate Tectonics",
          "versions": {
            "v1": {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "This section phenomenologically formulates the interaction mechanics of spatial domains with differing phases."
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### A. Spatial Plates and Fault Lines"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "To preserve exact dimensional consistency and the rigorous tensor grammar of general relativity, we introduce a macroscopic coherence length constant ($L_c$). The effective geometrical stress tensor $S_{\\mu\\nu}$ accumulated due to the phase mismatch ($\\Delta\\theta$) is rigorously modeled as:"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### B. Resolution of the Domain Wall Problem"
              }
            }
          },
          {
      ...
      },
      {
        ...
        "title": {
          ...
          "en": "III. Topology of Wave Interference and Large-Scale Structures",
          "versions": {
            "v1": {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "This study suggests that the cosmic large-scale structure may be interpreted as a deterministic topology sculpted by the wave interference of spatial plates."
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### A. Destructive Interference and Energy Redistribution: Cosmic Voids"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### B. Constructive Interference: Cosmic Web Filaments"
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "Along linear fault lines where phases nearly match ($\\Delta\\theta \\approx 0$), constructive interference amplifies the vibration energy, emerging as effective surplus gravity. Galaxies accumulate in these fault valleys, forming galactic filaments [3]. Large-scale attractors could potentially be interpreted as spatial plate nodes where multiple constructive interferences converge."
              }
            }
          },
          {
      ...
      },
      {
        ...
        "title": {
          ...
          "en": "IV. Cosmic Seismology and Macroscopic Spatial Separation",
          "versions": {
            "v1": {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "Fast Radio Bursts (FRBs) [4] are proposed here to be potentially associated with **'Cosmic Quakes'** caused by the rupture of spatial fault lines."
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### A. Phase Locking (Foreshocks) and Fault Rupture (Main Quake)"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "Conversely, when this accumulated stress exceeds the spacetime elastic critical limit ($S_{\\mathrm{crit}}$), a full rupture ('main quake') occurs. The pent-up tensor energy erupts explosively, dissipating instantaneously as an ultra-high-frequency (GHz band) gravitational wave burst."
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### B. Electromagnetic Conversion via the Gertsenshtein Effect"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "### C. Extreme Rupture: Macroscopic Topological Pinch-off and Spatial Separation"
              }
            }
          },
          {
      ...
      },
      {
        ...
        "title": {
          ...
          "en": "V. The POINTING Predictive Protocol",
          "versions": {
            "v1": {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v3": {
                "ko": "",
                "en": "Once the map is complete, the rupture probability function ($P_{quake}$) at the fault intersecting nodes—where stress concentrates—is calculated.\n$$ P_{quake}(x,y,z, t) \\propto \\int_{0}^{t} \\exp\\left( \\frac{S_{\\mu\\nu} - S_{crit}}{\\alpha} \\right) dt' $$\nBy pinpointing critical coordinates where this function nears its limit, this protocol proposes a paradigm reversal in observational astronomy: proactively directing next-generation radio telescopes to empty coordinates *before* an imminent extreme explosion (FRB/GRB) occurs."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "By analyzing the anisotropic data of the ultra-low-frequency (nHz) 'Stochastic Gravitational-Wave Background (SGWB)' [6] acting as foreshocks, it may be possible to reconstruct a **'3D Topology Map of Cosmic Spatial Fault Lines'**."
              }
            }
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "To satisfy rigorous mathematical validity, the rupture probability function ($P_{\\mathrm{quake}}$) at fault intersecting nodes is formalized using the scalar norm of the stress tensor ($\\| S_{\\mu\\nu} \\|$):"
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "This establishes the theoretical **POINTING** protocol: by actively monitoring the nHz SGWB foreshocks, radio telescopes can be proactively directed to specific coordinates before an imminent extreme explosion (GHz FRB main quake) occurs, serving as a falsification test for this cosmological framework."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v6": {
                "ko": "이 약어의 각 요소는 다음과 같은 물리적, 관측적 의미를 지닌다:\n1. **Phasic Observation**: 확률론적 배경 중력파(SGWB)와 FRB의 위상 동기화(Phase-locking) 현상을 포착하는 관측 방식.\n2. **Interferometric Network**: 나노그라브(NANOGrav) [6]와 같은 펄사 타이밍 배열(PTA) 네트워크를 활용한 간섭계적 접근.\n3. **Tensor-field Induced**: 공간 진동 모델의 핵심인 텐서 장(Tensor field)이 시공간 변형을 유도하는 기제.\n4. **Neural Gravitational-signals**: 기계학습(Neural Network) 기반의 패턴 인식을 통해, 극초저주파(nHz) 전조 현상과 고주파(GHz) 폭발 신호 사이의 비선형적 상관관계를 찾아내는 분석 방법론.",
                "en": ""
              }
            }
          },
          ...
          },
          {
            ...
            "versions": {
              "v6": {
                "ko": "",
                "en": "To observationally falsify and demonstrate this framework, we introduce the **POINTING** protocol (**P**hasic **O**bservation & **I**nterferometric **N**etwork for **T**ensor-field **I**nduced **N**eural **G**ravitational-signals)."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v6": {
                "ko": "",
                "en": "By actively monitoring the nHz SGWB foreshocks via the **POINTING** protocol, radio telescopes can be proactively directed to specific coordinates before an imminent extreme explosion (GHz FRB main quake) occurs, establishing a predictive observational methodology."
              }
            }
          }
        ]
      },
      {
        ...
        "title": {
          "ko": "6. 3부작 총결론",
          "en": "VI. Conclusion of the Trilogy",
          "versions": {
            "v1": {
        ...
        "paragraphs": [
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "The Mechanics of Spatial Vibration series presents a unified conceptual framework attributing quantum wave-particle duality, dark sector phenomena, and cosmic large-scale structures to the geometrical fluctuation of space and its scale-dependent interactions with mass inertia."
              }
            }
          },
          {
          ...
          },
          {
            ...
            "versions": {
              "v4": {
                "ko": "",
                "en": "As a highly speculative framework, establishing the physical validity of Spatial Plate Tectonics requires rigorous relativistic derivations, cosmological N-body simulations incorporating tensor friction, and direct verification through the proposed POINTING protocol."
              }
            }
          },
          {
