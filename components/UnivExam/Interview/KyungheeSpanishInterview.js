...
const KyungheeSpanishInterview = ({ completionStatus = {}, toggleCompletion, user }) => {
  ...
  const CommonQuestionsSection = () => {
    ...
    const questions = [
        ...
        versions: [
          {
            ...
            content: "호기심과 탐구에 대한 열정을 중심으로 고교시절의 일관된 주제를 언급하고, 언어·철학·사회·예술 등을 융합적으로 공부하며 사고의 폭을 넓혀온 경험을 강조합니다. 스페인어를 배우면서 언어가 단순한 의사소통 수단이 아니라 역사와 문화, 가치관을 담고 있다는 점에 매력을 느낀 점을 언급하고, 학급에서의 협력과 책임, 독서와 토론을 통한 비판적 사고력 성장을 설명합니다."
          },
          {
        ...
        versions: [
          {
            ...
            content: "스페인어와 스페인어권 문화에 대한 깊은 흥미를 바탕으로 지원했습니다. 고등학교에서 스페인과 한국의 문화 비교, 다중언어정책 분석 등을 통해 언어가 사회의 가치와 정체성을 반영한다는 점을 깨달았습니다. 경희대의 교환학생과 문화 교류 프로그램을 통해 국제적 소통 능력과 비판적 사고력을 키워 외교와 국제협력 분야에서 활약하고 싶습니다."
          },
          {
            title: "버전 2: 탐구 경험 중심",
        ...
        versions: [
          {
            ...
            content: "입학 후 스페인어 회화, 문법, 독해 등 전공의 기초를 다지고, 중·고급 단계에서는 스페인과 중남미의 문화·정치·경제를 심화 탐구하여 폭넓은 지역이해력을 키우겠습니다. 교환학생 프로그램을 적극 활용해 글로벌 역량을 강화하고, 방학 중 인턴십을 통해 실무 경험을 쌓아 학문적 이해와 실질적 현장 감각을 갖춘 국제형 인재로 성장하겠습니다."
          },
          {
            title: "버전 2: 융합 학습 계획",
        ...
        versions: [
          {
            ...
            content: "졸업 후 해외 교류 및 국제 비즈니스 관련 직무에서 실무 경험을 쌓고, 스페인어권 시장과 기업 간 협력에 기여하고 싶습니다. 이후 대학원에 진학해 언어·문화 교류 또는 국제관계 분야의 연구를 심화하고, 궁극적으로는 한국과 스페인·중남미를 연결하는 문화·경제 교류 전문가로 성장해 언어를 매개로 상호 이해와 협력을 이끌어내는 역할을 하겠습니다."
          },
          {
        ...
        versions: [
          {
            ...
            content: "여러 대학을 비교해보았지만, 경희대 스페인어학과만의 강점은 스페인어학뿐만 아니라 스페인어 문화와 스페인어권 사회를 종합적으로 배울 수 있다는 점입니다. 경희대의 교환학생 프로그램, 문화 체험, 다양한 국제 교류 기회는 다른 대학과 차별화된 경쟁력이라고 생각합니다. 스페인어권 국가들과의 긴밀한 네트워크와 교류 프로그램을 통해 실제로 언어와 문화를 체험할 수 있는 기회가 풍부하며, 이는 단순히 언어를 배우는 것을 넘어 지역 전문가로 성장하는 데 큰 도움이 될 것입니다. 또한 경희대의 '문화세계창조' 이념은 제가 추구하는 가치와 일치하며, 이러한 점에서 경희대가 저에게 가장 잘 맞는 학교라고 확신합니다."
          },
          {
      ...
      {
        number: 6,
        title: "학업에 방해가 될 수 있는 요인이 있나요?",
        versions: [
          {
            title: "버전 1: 자기관리 능력 강조",
            content: "저는 학업에 방해가 될 만한 특별한 요인은 없다고 생각합니다. 고등학교 시절부터 꾸준히 학업과 다양한 활동을 병행하며 시간 관리 능력을 키워왔고, 학업을 최우선으로 두는 태도를 유지해왔습니다. 물론 대학 생활에서 다양한 유혹이나 어려움이 있을 수 있지만, 저는 명확한 목표 의식을 가지고 있으며, 스페인어 전문가가 되겠다는 확고한 의지가 있습니다. 또한 스스로를 관리하고 계획을 세워 실천하는 습관이 잘 형성되어 있어, 학업에 집중하면서도 다양한 경험을 쌓을 수 있을 것이라 확신합니다."
          },
          {
            title: "버전 2: 구체적 경험 기반",
            content: "저는 고등학교 3년 동안 체계적인 시간 관리와 자기주도적 학습 태도를 유지해왔습니다. 1학년 때는 오답노트를 적극 활용하여 학습 내용을 복습했고, 2학년 때는 매일 아침 계획표를 세우고 실천하는 습관을 길렀습니다. 학급 영어회화활동 대표위원으로 1년 동안 활동하며 조원들의 참여를 독려하고 다른 조의 활동까지 총괄하면서도 학업 성적을 유지했습니다. 교육봉사반과 사회과학연구반, 인문학연구반, 철학연구반 등 다양한 동아리 활동을 병행하며 시간을 효율적으로 관리하는 능력을 키웠습니다. 또한 틈틈이 책을 읽으며 지적 호기심을 충족시켰고, 어려움을 만나도 곧바로 다시 일어서는 긍정적인 자세를 갖추었습니다. 이러한 경험을 바탕으로 대학에서도 학업에 전념하면서 다양한 활동을 균형있게 이어갈 자신이 있습니다."
          }
        ]
      }
    ];
