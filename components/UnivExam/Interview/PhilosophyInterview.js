 ...
 */
const PhilosophyInterview = ({ completionStatus = {}, toggleCompletion, user }) => {
      ...
      <div className="questions-section">
        ...
        <div className="questions-list">
          {filteredQuestions.map((question, index) => {
            const isCompleted = completionStatus.philosophyInterview?.includes(question.id) || false;
                  ...
                  <div className="toggle-container">
                    <label className="toggle-switch">
                      <input
                        ...
                        checked={isCompleted}
                        onChange={() => toggleCompletion && toggleCompletion('philosophyInterview', question.id)}
                        disabled={!user}
