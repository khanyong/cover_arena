          ...
          <div className="h-full flex flex-col p-10 relative z-10 justify-between">
            <div>
              <div className="flex justify-between items-start mb-2 border-b-4 border-blue-600 pb-2">
                <div>
                  <span className="bg-blue-100 text-blue-800 text-xs font-black px-2.5 py-0.5 rounded tracking-wide uppercase mr-2">Growth Strategy</span>
                  <h2 className="text-[1.85rem] font-black text-slate-800 inline-block">주요 고객사별 양산 전개 계획</h2>
                </div>
                ...
                <div className="flex flex-col gap-3 flex-1 justify-center">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 shadow-xs">
                    <div className="flex justify-between items-center mb-1.5">
                      ...
                      <span className="bg-green-100 text-green-800 border border-green-300 text-[11px] font-bold px-2.5 py-0.5 rounded-full">
                        4개 모델 선정
                      </span>
                    </div>
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 shadow-xs">
                    <div className="flex justify-between items-center mb-1.5">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-500 font-bold">OLED 패널 글로벌 제조사</p>
                      </div>
        ...
        <div className={getSlideClass(6, 'bg-white')}>
          <div className="h-full flex flex-col p-10 relative z-10 justify-between">
            <div>
              <div className="flex justify-between items-start mb-2 border-b-4 border-blue-600 pb-2">
                <div>
                  <span className="bg-emerald-100 text-emerald-800 text-xs font-black px-2.5 py-0.5 rounded tracking-wide uppercase mr-2">Turnaround Fact</span>
                  <h2 className="text-[1.85rem] font-black text-slate-800 inline-block">본질적 수익성 흑자 턴어라운드</h2>
                </div>
                <span className="text-xs text-slate-500 font-bold bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200">부실 전액 해소 &amp; 고수익 전환</span>
              </div>
              <p className="text-[13px] text-slate-800 mb-3 border-l-4 border-blue-600 pl-3 bg-blue-50/70 py-1.5 font-medium border border-blue-100 rounded-r-lg break-keep">
              ...
              <div className="w-[54%] bg-slate-50 border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between relative">
                ...
                <div className="relative h-[250px] w-full flex items-center justify-between px-3 mt-1">
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-start h-full pt-[135px] w-24">
                    ...
                    <span className="text-base font-black text-red-600 mt-1">-51.9억</span>
                    <span className="text-[10px] text-slate-600 font-bold whitespace-nowrap">장부상 손실</span>
                  </div>
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center pb-8">
                    ...
                    <svg className="w-8 h-4 text-emerald-600 mt-0.5" viewBox="0 0 32 16" fill="none">
                      ...
                      <path d="M22 2L29 2L29 9" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-end h-full pb-[115px] w-24">
                    ...
                    <div className="mt-1 text-center">
                      <span className="text-[10.5px] text-blue-900 font-black block whitespace-nowrap">매출 400억</span>
                      <span className="text-[9.5px] text-slate-600 font-semibold">(OPM 9.9%)</span>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-end h-full pb-[115px] w-24">
                    ...
                    <div className="mt-1 text-center">
                      <span className="text-[10.5px] text-indigo-900 font-black block whitespace-nowrap">매출 700억</span>
                      <span className="text-[9.5px] text-slate-600 font-semibold">(OPM 11.3%)</span>
                    </div>
                  </div>
                </div>
              </div>
