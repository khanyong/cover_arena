...
export default function TemscoPage() {
  const handlePrint = () => {
    window.print()
  }
      ...
      <header className="no-print bg-slate-800/95 backdrop-blur border-b border-slate-700 text-white px-6 py-3.5 flex items-center justify-between sticky top-0 z-50 shadow-xl">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center gap-2">
            <span className="bg-blue-600 text-xs px-2.5 py-0.5 rounded font-black tracking-wider uppercase">IR Pitch Deck</span>
            <h1 className="text-sm md:text-base font-bold text-white">
              주식회사 템스코 (TEMSCO) 투자제안서
            </h1>
          </div>
        </div>
          ...
          <div className="h-full flex flex-col p-12">
            ...
            <div className="grid grid-cols-2 gap-5 h-full pb-2">
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-start relative shadow-sm hover:shadow-md transition">
                <div className="text-blue-600 text-[1.75rem] mb-2"><i className="fa-solid fa-layer-group"></i></div>
                <h3 className="text-lg font-bold mb-1.5 text-slate-800">소재·부품 수직계열화 토탈 솔루션 완성</h3>
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-start relative shadow-sm hover:shadow-md transition">
                <div className="text-indigo-600 text-[1.75rem] mb-2"><i className="fa-solid fa-earth-asia"></i></div>
                <h3 className="text-lg font-bold mb-1.5 text-slate-800">글로벌 Top-tier 1차 벤더(Tier-1) 직납 승격</h3>
                <p className="text-gray-700 text-[13px] leading-relaxed">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-start relative shadow-sm hover:shadow-md transition">
                <div className="text-emerald-600 text-[1.75rem] mb-2"><i className="fa-solid fa-handshake-angle"></i></div>
                <h3 className="text-lg font-bold mb-1.5 text-slate-800">위기를 기회로 전환한 턴어라운드 & 직수출 확대</h3>
                <p className="text-gray-700 text-[13px] leading-relaxed">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-start relative shadow-sm hover:shadow-md transition">
                <div className="text-slate-700 text-[1.75rem] mb-2"><i className="fa-solid fa-chart-line"></i></div>
                <h3 className="text-lg font-bold mb-1.5 text-slate-800">2025년 잠재 부실 완전 해소 & 퀀텀점프 실적</h3>
                <p className="text-gray-700 text-[13px] leading-relaxed">
          ...
          <div className="h-full flex flex-col p-14 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-8 flex-1">
                ...
                <div className="space-y-6">
                  <div className="bg-slate-50 p-5 rounded-lg border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="bg-green-100 text-green-800 border border-green-300 text-sm font-bold px-3 py-1 rounded-full"><i className="fa-solid fa-circle-check mr-2"></i>4개 모델 선정</span>
                    </div>
                  ...
                  <div className="bg-slate-50 p-5 rounded-lg border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="bg-green-100 text-green-800 border border-green-300 text-sm font-bold px-3 py-1 rounded-full"><i className="fa-solid fa-handshake mr-2"></i>메인 공급사 공식 선정</span>
                    </div>
                    <ul className="text-sm text-slate-700 space-y-2 mt-3">
                      <li>• <b>부품:</b> 메탈마스크 1차 벤더 <b>최우선 협상 대상자 및 메인 공급사 공식 선정</b></li>
                      <li>• <b>소재:</b> 몰리브덴(Mo)/알루미늄(Al) 타겟 평가 후 은(Ag) 합금 스퍼터링 타겟 순차 확대</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-slate-300 shadow-sm relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-6 flex items-center border-b border-slate-200 pb-3"><i className="fa-solid fa-globe text-emerald-600 mr-3"></i>글로벌 패널사 &amp; 반도체/XR 장비사</h3>
                <div className="space-y-6">
                  <div className="bg-slate-50 p-5 rounded-lg border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                      <div>
                        <h4 className="font-black text-xl text-slate-900">중국 Visionox &amp; CSOT</h4>
                        <p className="text-xs text-slate-500 mt-1 font-bold">OLED 패널 글로벌 제조사</p>
                      </div>
                      <span className="bg-blue-100 text-blue-800 border border-blue-300 text-sm font-bold px-3 py-1 rounded-full"><i className="fa-solid fa-boxes-packing mr-2"></i>물량 30% 배정 확정</span>
                    </div>
                  ...
                  <div className="flex gap-4">
                    <div className="flex-1 bg-slate-50 p-5 rounded-lg border border-slate-200 shadow-sm">
                      ...
                      <p className="text-xs text-slate-500 mb-3 font-bold">글로벌 장비사 / 초고해상도 XR</p>
                      <span className="bg-yellow-100 text-yellow-800 text-xs font-bold px-2 py-1 rounded border border-yellow-300">1차 벤더 등록 완료</span>
                    </div>
                    <div className="flex-1 bg-slate-50 p-5 rounded-lg border border-slate-200 shadow-sm">
                      <h4 className="font-black text-lg text-slate-900 mb-1">반도체 신사업 파이프라인</h4>
                      <p className="text-xs text-slate-500 mb-3 font-bold">HF 봄베 / CuMn 타겟 / 구리기판</p>
                      <span className="bg-purple-100 text-purple-800 text-xs font-bold px-2 py-1 rounded border border-purple-300">시제품 평가 전개</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex items-start justify-center gap-12 mt-4">
              <div className="w-[55%] relative h-[380px] border-b-2 border-slate-800 flex items-end justify-between px-10 pb-0 bg-slate-50 rounded-xl pt-10 border border-slate-200 shadow-sm">
                ...
                <div className="relative z-10 flex flex-col items-center justify-start h-full pt-[180px]">
                  <div className="w-24 bg-red-500 rounded-b h-[90px] shadow-sm flex flex-col items-center justify-center text-white font-bold relative border border-red-600 text-xs text-center leading-tight">
                    <span>2025년</span>
                    <span className="text-[10px] text-red-100 font-normal">대손 63.7억 반영</span>
                  </div>
                  <span className="text-xl font-black text-red-600 mt-2">-51.9억</span>
                  <span className="text-slate-800 font-bold whitespace-nowrap text-sm mt-0.5">장부상 영업손실</span>
                </div>
                {/* Turnaround Growth Bridge (2025 -> 2026) */}
                <div className="relative z-10 flex flex-col items-center justify-center h-full pb-[40px] px-1">
                  <div className="bg-emerald-600 text-white font-black text-xs px-3 py-1 rounded-full shadow-md flex items-center gap-1.5 transform -rotate-6 animate-pulse">
                    <i className="fa-solid fa-arrow-trend-up"></i>
                    <span>+91.4억 반등</span>
                  </div>
                  <div className="flex flex-col items-center mt-1.5">
                    <span className="text-[11px] font-extrabold text-emerald-800 bg-emerald-100/90 px-2 py-0.5 rounded border border-emerald-300 shadow-sm whitespace-nowrap">
                      흑자 턴어라운드
                    </span>
                    <svg className="w-10 h-6 text-emerald-600 mt-1" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 20C14 20 22 14 34 6" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeDasharray="4 3"/>
                      <path d="M26 5L35 5L35 14" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center justify-end h-full pb-[200px]">
                  <span className="text-xl font-black text-blue-700 mb-2">+39.5억</span>
                  <div className="w-24 bg-blue-600 rounded-t h-[105px] shadow-sm flex items-center justify-center text-white font-bold text-center relative px-1 leading-tight text-sm">
                    2026(E)<br />영업이익
                  </div>
                  <span className="absolute -bottom-8 text-blue-900 font-black whitespace-nowrap text-sm">매출 400억 (OPM 9.9%)</span>
                </div>

                {/* Quantum Jump Growth Bridge (2026 -> 2029) */}
                <div className="relative z-10 flex flex-col items-center justify-center h-full pb-[110px] px-1">
                  <div className="bg-indigo-600 text-white font-black text-xs px-3 py-1 rounded-full shadow-md flex items-center gap-1.5 transform -rotate-12">
                    <i className="fa-solid fa-bolt text-yellow-300"></i>
                    <span>2.0배 성장</span>
                  </div>
                  <div className="flex flex-col items-center mt-1.5">
                    <span className="text-[11px] font-extrabold text-indigo-800 bg-indigo-100/90 px-2 py-0.5 rounded border border-indigo-300 shadow-sm whitespace-nowrap">
                      퀀텀점프 스케일업
                    </span>
                    <svg className="w-10 h-6 text-indigo-600 mt-1" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 20C14 18 24 12 34 5" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeDasharray="4 3"/>
                      <path d="M26 4L35 4L35 13" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                </div>
                ...
                {/* Bar 3: 2029(E) */}
                <div className="relative z-10 flex flex-col items-center justify-end h-full pb-[200px]">
                  <span className="text-2xl font-black text-indigo-700 mb-2">+78.9억</span>
                  <div className="w-28 bg-indigo-700 rounded-t h-[140px] shadow-sm relative border border-indigo-800 flex items-center justify-center text-white font-bold text-sm">
                    2029(E) OP
                  </div>
                  <span className="absolute -bottom-8 text-indigo-900 font-black whitespace-nowrap text-sm">매출 700억 (OPM 11.3%)</span>
                </div>
              </div>
              <div className="w-[45%] h-full flex flex-col gap-5">
                <div className="bg-white border border-slate-200 p-6 rounded-xl shadow-sm">
                  <h4 className="font-bold text-lg text-slate-800 mb-2 border-b border-slate-200 pb-2 flex items-center"><i className="fa-solid fa-shield-halved mr-2 text-slate-500"></i>Clean Balance Sheet 달성</h4>
                ...
                <div className="bg-blue-50 border border-blue-200 p-6 rounded-xl shadow-sm flex-1">
                  <h4 className="font-bold text-lg text-blue-900 mb-2 border-b border-blue-200 pb-2 flex items-center"><i className="fa-solid fa-rocket mr-2 text-blue-600"></i>고수익 직납 체제 안착</h4>
              ...
              <table className="w-full text-center text-xs">
                ...
                <tbody className="font-medium text-slate-700 text-[11.5px]">
                  ...
                  <tr className="bg-indigo-50/80 border-b border-indigo-100 font-bold text-indigo-950">
                    ...
                    <td>100.6</td><td>55.7</td>
                    <td className="text-indigo-700 font-black bg-indigo-100/50">160.0</td>
                    <td className="font-bold text-indigo-800">247.5</td>
                    <td className="font-bold">294.0</td>
                  ...
                  <tr className="border-b border-slate-100 text-slate-600">
                    ...
                    <td>86.5</td><td>47.6</td><td>134.4</td><td>207.9</td><td>247.0</td><td>297.4</td>
                  </tr>
                  <tr className="border-b-2 border-indigo-200 bg-indigo-50/40 text-indigo-950 font-bold">
                    <td className="py-1 text-left pl-8 border-r border-slate-200 text-indigo-900">└ 마스크 매출총이익 (16.0%)</td>
                    <td>14.1 (14.0%)</td><td>8.1 (14.5%)</td>
                    <td className="text-indigo-700 font-bold">25.6 (16.0%)</td>
                    <td className="font-bold">39.6 (16.0%)</td>
                    <td className="font-bold">47.0 (16.0%)</td>
                  ...
                  <tr className="bg-blue-50/80 border-b border-blue-100 font-bold text-blue-950">
                    ...
                    <td>298.0</td><td>294.9</td>
                    <td className="text-blue-700 font-black bg-blue-100/50">240.0</td>
                    <td className="font-bold text-blue-800">272.5</td>
                    <td className="font-bold">306.0</td>
                  ...
                  <tr className="border-b border-slate-100 text-slate-600">
                    ...
                    <td>271.7</td><td>265.1</td><td>197.6</td><td>223.7</td><td>251.0</td><td>283.6</td>
                  </tr>
                  <tr className="border-b-2 border-blue-200 bg-blue-50/40 text-blue-950 font-bold">
                    <td className="py-1 text-left pl-8 border-r border-slate-200 text-blue-900">└ 소재 매출총이익 (17.7~18.0%)</td>
                    <td>26.3 (8.8%)</td><td>29.8 (10.1%)</td>
                    <td className="text-blue-700 font-bold">42.4 (17.7%)</td>
                    <td className="font-bold">48.8 (17.9%)</td>
                    <td className="font-bold">55.0 (18.0%)</td>
            ...
            <div className="grid grid-cols-2 gap-4 flex-1">
              <div className="bg-indigo-50/60 border border-indigo-200 rounded-2xl p-5 flex flex-col justify-between shadow-sm">
                ...
                <div className="bg-white/95 p-2.5 px-3.5 rounded-xl border border-indigo-100 mt-2 text-[12px] text-indigo-950 font-bold text-left shadow-xs break-keep flex items-start gap-1.5">
                  ...
                  <span><b>메탈마스크 매출 비중:</b> 2025년 15.9% ➔ 2026년 40.0% ➔ 2029년 50.6%로 전사 핵심 캐시카우 도약</span>
                </div>
              </div>
              ...
              <div className="bg-blue-50/60 border border-blue-200 rounded-2xl p-5 flex flex-col justify-between shadow-sm">
                <div>
                  ...
                  <ul className="text-[13.5px] text-slate-800 space-y-2.5 leading-snug font-medium break-keep">
                    ...
                    <li className="flex items-start gap-1.5">
                      <span className="text-blue-600 font-bold select-none flex-shrink-0">•</span>
                      <span><b>고청정 특수강 비철소재:</b> 고진공 챔버 및 정밀부품용 Ni특수강/SUS420 안정적 상품 유통망 확대</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <span className="text-blue-600 font-bold select-none flex-shrink-0">•</span>
